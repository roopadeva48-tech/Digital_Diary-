...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-30 bg-[#FAF6EE]/90 backdrop-blur-md border-b border-[#E8DEC8] px-4 sm:px-8 py-3.5 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          <Logo size="sm" showSlogan={false} className="scale-75 origin-left" />
          <div className="hidden sm:block">
            <h1 className="text-base font-serif-display font-bold text-[#453022] leading-none">
              AuraPages
            </h1>
            <p className="text-[11px] text-[#8C6D53] tracking-wide font-editorial">
        ...
        {/* User Info & Actions */}
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-[#F3E8DA] px-3 py-1.5 rounded-full border border-[#DFCEBA]">
          ...
          <button
            ...
            onClick={onLogout}
            title="Log Out"
            className="p-2 rounded-xl text-[#8C6D53] hover:text-[#453022] hover:bg-[#EFE2D3] transition-colors"
          >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#FFFDF9] border border-[#E9DFD0] rounded-2xl p-5 sm:p-7 shadow-xs relative overflow-hidden">
          {/* Decorative washi strip */}
          <div className="absolute top-0 right-10 w-28 h-4 bg-[#EAD1B9]/70 rounded-b-sm" />

          <div>
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#99633B]">
              <Sparkles className="w-3.5 h-3.5 text-[#C47D42]" />
              <span>Sanctuary Collection</span>
            </div>
            <h2 className="mt-1 text-2xl sm:text-3xl font-serif-display font-bold text-[#3B291D]">
              Welcome back, {user.name}
            </h2>
            <p className="text-xs sm:text-sm text-[#7F644E] mt-1 font-editorial">
          ...
          <div className="flex flex-col xs:flex-row flex-wrap items-stretch xs:items-center gap-3">
            <div className="flex items-center justify-center gap-4 bg-[#FAF5EC] px-4 py-2 rounded-xl border border-[#E8DAC9] text-xs text-[#6B503B]">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-[#9E5728] hover:bg-[#85451C] text-white text-xs sm:text-sm font-semibold px-4 py-2.5 rounded-xl shadow-sm transition hover:shadow-md cursor-pointer"
            >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            <Search className="w-4 h-4 text-[#A88C76] absolute left-3.5 top-1/2 -translate-y-1/2" />
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-[#FFFDF9] border border-[#E5DACD] rounded-xl text-xs sm:text-sm text-[#3E2B1F] placeholder:text-[#AFA090] focus:outline-none focus:ring-2 focus:ring-[#C47D42]/30 transition"
            />
            {searchQuery && (
              <button
                type="button"
                onClick={() => setSearchQuery('')}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#A88C76] hover:text-[#543825]"
              >
                Clear
              </button>
            )}
          ...
          {/* Filter Tabs */}
          <div className="flex items-center gap-1.5 bg-[#F2E8DB] p-1 rounded-xl border border-[#E2D4C3] self-start sm:self-auto">
            <button
              type="button"
            ...
            >
              <Star className="w-3 h-3 text-[#C47D42] fill-[#C47D42]" />
